...
public class Weather {
    ...
    Weather(double temp, String clouds, long humidity, long pressure, long visibility, double wind, long sunrise, long sunset){
        //this.setName(name);
...
*/
    ...
    public String toString() {
        String str = "\nTemp: " + (Math.floor((getTempature()-274) * 100) / 100) + "\nWind: " + getWindSpeed() + "\nClouds: " + getClouds() + "\nVisibility: " + getVisibility()  + "\nPressure: " + getPressure() + "\nHumidity: " + getHumidity();
        return str;
    }
}
